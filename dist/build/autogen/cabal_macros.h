...
/* package Hungarian-Munkres-0.1.5 */
#define VERSION_Hungarian_Munkres "0.1.5"
#define MIN_VERSION_Hungarian_Munkres(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package hierarchical-clustering-0.4.4 */
#define VERSION_hierarchical_clustering "0.4.4"
